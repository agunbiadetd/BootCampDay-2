...
describe("words()", function() {
  ...
  it("handles properties that exist on Object's prototype", function() {
    var expectedCounts = { reserved: 1, words : 1, like :1,  prototype: 1, and : 1, to: 1, String: 1, "ok?": 1};
    expect(words("reserved words like prototype and to String ok?")).toEqual(expectedCounts);
  });
});
